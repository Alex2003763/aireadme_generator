      ...
      <div className="container mx-auto px-4 py-6 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <button
            ...
            className="text-slate-400 hover:text-indigo-400 transition-colors duration-200 p-2 rounded-full hover:bg-slate-700"
            title="Settings - API Key Configuration"
            aria-label="Open settings for API key configuration"
          >
          ...
          <a 
            href="https://github.com/your-github-username/readme-generator-app" // Replace with actual link if you host it
            target="_blank" 
            rel="noopener noreferrer"
            className="text-slate-400 hover:text-indigo-400 transition-colors duration-200"
            title="View on GitHub (Example Link)"
          >
